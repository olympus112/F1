...
let renderTimeConsistency = (inputData, colors) => {
...
let renderRaceConsistency = (inputData, colors) => {
    let data = inputData.data;
    let lsmPoints = inputData.lsm.lsmPoints;
    ...
    renderGraph(data, lsmPoints, g, x, y, colors);
};
...
function renderGraph(data, lsmPoints, svg, x, y, colors) {
    let indices = d3.range(data.length);
    let area = d3.area()
